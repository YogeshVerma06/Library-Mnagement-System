...
class maincode:
     ...
     def login(self):
         ...
         if self.ab!=None:
             ...
             self.name=Label(root,text="Name : ",bg='#fff',fg="black",font=('Arial',12,'bold'))
             self.name.place(x=5,y=83)
             self.name1=Label(root,text=self.ab[1],fg='black',bg='#fff',font=('Arial',12,'bold'))
     ...
     def cur(self):
             ...
             self.develop=Label(self.fm3,text='Developed By - Yogesh, Yash, Mayank',bg='#fff',fg='blue',
         ...
         class temp(maincode):
             ...
             def submit1(self):
                try : 
                    ...
                    dd.commit()
                    self.clear()
                    messagebox.showinfo("Library System","Book Add Successfully !")
                except Exception as e:
                    messagebox.showinfo("Library System","All are field required")
     ...
     def issuebook(self):
         class test(maincode):
              ...
              def mail(self):
                    ...
                    self.var=cursor.fetchone()
                    sender = "itsyogshverma@gmail.com"
                    reciever =self.var[5]
     ...
     def delete(self):
         class dele(maincode):
               ...
               def deldata(self):
                    ...
                    #  if self.da==None:
                    #       messagebox.showinfo('Library System','all field required !')
                    #  else:
                    ...
                    #     self.da=cursor.fetchone()
                    # except Exception as e:
                    #     messagebox.showinfo("Library System","Invelid !!")
                    ...
                    #     # val = (n1.get())
                    #     cursor1.execute=("SELECT Book_ID FROM stbook")
                    #     cursor1=dd.cursor1()
                    #     dd.commit()
                    #     if self.a in cursor1:
                    #         cursor=dd.cursor()
                    #         cursor.execute("DELETE FROM stbook WHERE Book_ID='"+self.a+"'")
                    #         dd.commit()
                    #         messagebox.showinfo('Library System','YOUR DATA IS DELETED !')
                    ...
                    #     else:
                    #         messagebox.showinfo('Success',"Invelid")

                    #  except Exception as e:
                    #     messagebox.showinfo("Please check ","Please check Book ID")
                    #     print("error:",e)
                    # -------------------------------------------------------------------------------
